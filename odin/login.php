...
if ( !extension_loaded('pdo') ) {
	die( 'Failed to connect to database. PHP PDO is not enabled/installed!');
}
if ( !extension_loaded('pdo_pgsql') ) {
	die('Failed to connect to database. PGSQL extension for PHP PDO is not installed/enabled!');
}

//checking permissions to directories
$perm_err = array();
if (!is_writable("map/")){
	$perm_err[] = "ODIN must have write permission to it's map directory.";
}
if (!is_writable("savedxmls/")){
	$perm_err[] = "ODIN must have write permission to it's savedxmls directory.";
}
if (!is_writable("uploads/")){
	$perm_err[] = "ODIN must have write permission to it's uploads directory.";
}
